...
from backend.my_notes_logic import get_all_notes


def display_my_notes_page(contentFrame, on_open_note,on_create_note):
    style = ttk.Style()
    ...
    # TITLE OF CONTENT
    titleLabel = ttk.Label(titleFrame, text="My Notes", style="title.TLabel")
    ...
    # CREATE BUTTON
    createNote = ttk.Button(buttonSearchFrame, text="Create", style="createNote.TButton", command=on_create_note)
    createNote.pack(pady=20, padx=(0,20), anchor="e")
